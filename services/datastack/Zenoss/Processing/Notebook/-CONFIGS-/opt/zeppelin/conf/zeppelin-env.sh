...
# export JAVA_HOME=
export MASTER=spark://spm0:7077                		# Spark master url. eg. spark://master_addr:7077. Leave empty if you want to use local mode.
...
export ZEPPELIN_NOTEBOOK_DIR=/var/zenoss/datapipeline/etc/notebooks # Where notebook saved
#export ZEPPELIN_NOTEBOOK_HOMESCREEN=default1		# Id of notebook to be displayed in homescreen. ex) 2A94M5J1Z
